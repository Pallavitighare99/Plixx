...
import { uploadTrailerService } from '../Redux/APIs/ImageUploadService';
import Loader from './Notifications/Loader';

function Trailer({ setImageUrl }) {
    ...
    const onDrop = useCallback(
        async (acceptedFiles) => {
           ...
           const data = await uploadTrailerService(file, setLoading)
           setImageUrl(data)
        ...
        <div className='w-full text-center flex flex-col justify-center items-center gap-6'>
            {
                loading ? (
                    ...
                    <div
                        ...
                        <p className='text-sm mt-2'>Drag your Trailer here</p>
