        ...
        <div className='grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between'>
          {Links.map((link, index) => (
            <div key={index} className='col-span-1 md:col-span-2 xl:col-span-3 pb-3.5 sm:pb-0'>
              <h3 className='text-md lg:leading-7 font-medium mb-4 sm:mb-5 lg:md-6 pb-0.5'>{link.title}</h3>
          ...
          <div className='pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3'>
            <Link to="/">
              <img src='../../images/lloogo.png' alt='Plixx' className='w-2/4 object-contain h-12 ' />
            </Link>
            <p className='leading-7 text-sm text-border mt-3'>
              ...
              <br />
              <span>Tell: +91 9284777279</span>
              <br />
              <span>Email: pallavitighare01@gmail.com</span>
            </p>
          </div>
        </div>
      </div>
